...
public class MascheraConto extends Frame implements ActionListener
{
	...
	TextField tp,td;//tp=testo prestito td=testo deposito 
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getSource()==cd)
		{
			cd.saldo+=Integer.parseInt(td.getText());
			ls.setText(cd.saldo.toString());
		}
		if(e.getSource()==cp)
		{
			cd.saldo-=Integer.parseInt(tp.getText());
			ls.setText(saldo.toString());
		}
		if(e.getSource()==ap)
		{
			tp.setText("0");
